...
// Icono personalizado de Instagram (evita problemas de versiones en lucide)
...
export default function BookingPage() {
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      if (error) {
        console.error("Error al registrar reserva:", error.message);
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col items-center selection:bg-amber-500 selection:text-black">
      <header className="relative w-full max-w-lg overflow-hidden border-b border-zinc-800 bg-zinc-900">
        ...
        <div className="relative -mt-16 px-5 pb-5 text-center flex flex-col items-center">
            ...
            <div className="grid gap-2.5">
              {SERVICES.map((s) => (
                <button
                  ...
                  className="text-left p-3.5 rounded-xl border bg-zinc-900/80 hover:bg-zinc-850 border-zinc-800/80 text-zinc-200 transition flex items-center justify-between"
                >
                  <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-750 rounded-xl p-3 text-sm text-zinc-100 focus:outline-none focus:border-amber-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Ej: Solo degradar los laterales..."
                  value={notes}
